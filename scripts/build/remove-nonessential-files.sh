...
essential_found_in_chr87="
    ...
    ./src/third_party/swiftshader/tests/SystemUnitTests/BUILD.gn
    ./src/chrome/test/data/cast/BUILD.gn
    ./src/chrome/test/data/pdf/BUILD.gn
    ./src/chrome/test/data/webui/
"

essential_found_in_chr91="
    ./src/third_party/swiftshader/tests
    ./src/ios/features.gni
    ./src/content/test/data/web_ui_*
    ./src/chromecast/chromecast.gni
"
