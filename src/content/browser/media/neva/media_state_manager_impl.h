...
class CONTENT_EXPORT MediaStateManagerImpl : public MediaStateManager,
 ...
 public:
  ...
  MediaStateManagerImpl(const MediaStateManagerImpl&) = delete;
  MediaStateManagerImpl& operator=(const MediaStateManagerImpl&) = delete;
 ...
 private:
  ...
  // Convenience method that casts WebContents to a WebContentsImpl*.
  WebContentsImpl* web_contents_impl(WebContents* web_contents) const;
