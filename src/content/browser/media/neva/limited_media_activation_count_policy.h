...
class CONTENT_EXPORT LimitedMediaActivationCountPolicy
 ...
 public:
  ...
  LimitedMediaActivationCountPolicy(const LimitedMediaActivationCountPolicy&) =
      delete;
  LimitedMediaActivationCountPolicy& operator=(
      const LimitedMediaActivationCountPolicy&) = delete;
