...
#if defined(OS_WEBOS) && !(defined(USE_TV_MEDIA) || defined(USE_SIGNAGE_MEDIA))
class MediaSessionObserverWebOS;
...
#if defined(OS_WEBOS) && !(defined(USE_TV_MEDIA) || defined(USE_SIGNAGE_MEDIA))
  std::unique_ptr<MediaSessionObserverWebOS> media_session_observer_;
#endif  // defined(OS_WEBOS)
