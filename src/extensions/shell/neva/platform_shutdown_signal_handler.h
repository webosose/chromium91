...
#ifndef EXTENSIONS_SHELL_NEVA_PLATFORM_SHUTDOWN_SIGNAL_HANDLER_H_
#define EXTENSIONS_SHELL_NEVA_PLATFORM_SHUTDOWN_SIGNAL_HANDLER_H_
...
#endif  // EXTENSIONS_SHELL_NEVA_PLATFORM_SHUTDOWN_SIGNAL_HANDLER_H_
