...
struct COMPONENT_EXPORT(PLATFORM_WINDOW) VideoWindowParams {
  ...
  // if true, coded size is used for calculating video window geometry, instead
  // of natural size. Note that this option is working only if
  // |use_set_crop_region| is true.
