...
#include "ui/platform_window/neva/mojom/video_window.mojom-shared.h"
...
class StructTraits<ui::mojom::VideoWindowParamsDataView,
 ...
 public:
  ...
  static bool use_coded_size_for_original_rect(
      const ui::VideoWindowParams& params) {
    return params.use_coded_size_for_original_rect;
  }
