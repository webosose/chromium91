...
class WebMediaPlayerClient {
 public:
  ...
  virtual gfx::Rect ScreenRect() { return gfx::Rect(); }
  virtual WebMediaPlayer::RenderMode RenderMode() const {
    return WebMediaPlayer::RenderMode::RenderModeDefault;
  }
  virtual gfx::Rect WebWidgetViewRect() { return gfx::Rect(); }
  // TODO(neva): Deprecate.
  virtual void OnAudioFocusChanged() {}
  virtual void SendCustomMessage(const blink::WebMediaPlayer::MediaEventType,
                                 const WebString&) = 0;

  virtual void DidMediaCreated(bool will_use_media_resource) = 0;
  virtual void DidMediaActivated() = 0;
  virtual void DidMediaActivationNeeded() = 0;
  virtual void DidMediaSuspended() = 0;
