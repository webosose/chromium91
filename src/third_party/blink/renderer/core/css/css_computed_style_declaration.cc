...
const CSSPropertyID kComputedPropertyArray[] = {
    ...
    CSSPropertyID::kCaretColor, CSSPropertyID::kCaretWidth,
    ...
    CSSPropertyID::kMixBlendMode, CSSPropertyID::kNavIndex,
    CSSPropertyID::kNavUp, CSSPropertyID::kNavDown, CSSPropertyID::kNavLeft,
    CSSPropertyID::kNavRight, CSSPropertyID::kObjectFit,
