...
MojoMediaPlatformAPIService::MojoMediaPlatformAPIService(
  ...
  media_platform_api_ = media::MediaPlatformAPI::Create(
      ...
      BIND_TO_CURRENT_LOOP(&MojoMediaPlatformAPIService::OnVideoSizeChanged),
...
void MojoMediaPlatformAPIService::OnVideoSizeChanged(
    const gfx::Size& coded_size,
    const gfx::Size& natural_size) {
  if (media_platform_api_listener_remote_.get()) {
    media_platform_api_listener_remote_->OnVideoSizeChanged(coded_size,
                                                            natural_size);
  }
}
