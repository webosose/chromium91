...
#ifndef NEVA_PAL_SERVICE_PUBLIC_APPLICATION_REGISTRATOR_DELEGATE_H_
#define NEVA_PAL_SERVICE_PUBLIC_APPLICATION_REGISTRATOR_DELEGATE_H_
...
#endif  // NEVA_PAL_SERVICE_PUBLIC_APPLICATION_REGISTRATOR_DELEGATE_H_
