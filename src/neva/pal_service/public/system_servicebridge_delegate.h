...
#ifndef NEVA_PAL_SERVICE_PUBLIC_SYSTEM_SERVICEBRIDGE_DELEGATE_H_
#define NEVA_PAL_SERVICE_PUBLIC_SYSTEM_SERVICEBRIDGE_DELEGATE_H_
...
#endif  // NEVA_PAL_SERVICE_PUBLIC_SYSTEM_SERVICEBRIDGE_DELEGATE_H_
