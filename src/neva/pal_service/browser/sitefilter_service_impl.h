...
#ifndef NEVA_PAL_SERVICE_BROWSER_SITE_FILTER_SERVICE_H_
#define NEVA_PAL_SERVICE_BROWSER_SITE_FILTER_SERVICE_H_
...
#endif  // NEVA_PAL_SERVICE_BROWSER_SITE_FILTER_SERVICE_H_
