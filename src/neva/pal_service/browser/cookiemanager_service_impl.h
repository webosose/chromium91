...
#ifndef NEVA_PAL_SERVICE_BROWSER_COOKIE_MANAGER_SERVICE_IMPL_H_
#define NEVA_PAL_SERVICE_BROWSER_COOKIE_MANAGER_SERVICE_IMPL_H_
...
class CookieManagerServiceImpl : public mojom::CookieManagerService {
 public:
  ...
  void SetCookieOption(int32_t option, SetCookieOptionCallback callback) override;
...
#endif  // NEVA_PAL_SERVICE_BROWSER_COOKIE_MANAGER_SERVICE_IMPL_H_