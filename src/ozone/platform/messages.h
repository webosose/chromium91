...
IPC_MESSAGE_CONTROL1(WaylandInput_InitializeXKB,  // NOLINT(readability/fn_size)
...
IPC_MESSAGE_CONTROL1(WaylandInput_InputPanelLeave, uint32_t /*device_id*/)
