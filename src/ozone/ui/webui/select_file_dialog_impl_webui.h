...
class SelectFileDialogImplWebUI : public SelectFileDialog {
 ...
 protected:
  explicit SelectFileDialogImplWebUI(
      Listener* listener,
      std::unique_ptr<ui::SelectFilePolicy> policy);
  SelectFileDialogImplWebUI(const SelectFileDialogImplWebUI&) = delete;
  SelectFileDialogImplWebUI& operator=(const SelectFileDialogImplWebUI&) =
      delete;
